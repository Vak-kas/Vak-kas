...
|국립한밭대학교 컴퓨터공학과 40대 학생회 Eclipse|2023.12 ~ 2024.11|컴퓨터공학과 40대 학생회 총무|총무|
...
|알고리즘 TA| 2024.09.01 ~ 2024.12.21|국립한밭대학교 알고리즘 수업 TA||
|knockOn 부트캠프 3기 | 2024.11.1 ~ 2025.02.05 | 웹 모의해킹 트랙| TOP 7 |
...
|KnockOn 부트캠프 4기 | 2025.03.03 ~ 2025.06| MENTOR | 4기 멘토진 | 
| BoB 14기 | 2025.07.01 ~ 2025.12.24| 보안제품개발 트랙 | WhiteHat10 |
...
|RE4UEST CTF 대회 | 2024.11.10 | https://re4ctf.com/ | 참가 |
|LG U+ 해킹공격방어대회 | 2024.11.16 |존업생(김정훈, 서민재, 이경림)|참가|
|한밭페어 우수작품전시회|2024.11.20~2024.11.21|서버링 프로젝트 웹소켓으로 서버 상태 모니터링|우수작품|
|한국통신학회 추계종합학술발표회|2024.11|TDD 시스템에서 무선 채널 기반 물리 계층 인증에 관한 연구|우수상|
|국립한밭대학교 포트폴리오 경진대회|2024.12|-|수상|
|국립한밭대학교 포트폴리오 경진대회|2025.11|-|수상|
|국립한밭대학교 캡스톤 경진대회| 2025.11|-|동상|
|산학협력 Fair 캡스톤 경진대회| 2025.11|-|동상|
...
|서버링 프로젝트|2024.09.01~2024.11.31|서버의 상태를 모니터링 프로젝트|
...
|1회용 운영체제 제공 서비스 | 2024.12 ~ 2025.11 | 국립한밭대학교 캡스톤디자인 |
|알려지지 않은 URL 악성 행위 탐지 시스템| 2025.09~2025.12 | BoB 14기 보안제품개발 트랙 프로젝트 / 아키텍처 설계 및 연구|
...
|논문명|출판|저자|비고|
|----------|--------|--------------|----|
|IPDomain 기반의 알려지지 않은 악성 URL 탐지 기법 연구|한국통신학회|서민재, 정윤성, 이동우, 박수성, 류현, 곽나영, 이경문, 전상현|BoB 14기|
|다중 모듈 융합 멀티 스캐너를 이용한 알려지지 않은 악성 URL 탐지|한국정보보호학회|서민재, 이동우, 박수성, 류현, 정윤성, 곽나영, 이경문, 전상현|BoB 14기|
|피싱 url의 단기 생존 특성 분석 및 조기 예측 모델|한국정보보호학회|곽나영, 서민재, 정윤성, 이동우, 박수성, 류현, 이경문, 전상현|BoB 14기|
|웹 소켓 기반 웹 터미널을 통한 쿠버네티스 Pod 접속 시스템 설계|한국통신학회|서민재, 한하영, 김주령, 방인규*, 김태훈*|-|
|Presigned URL 기반 인증 과정 분석|한국통신학회|한하영, 서민재, 김주령, 방인규*, 김태훈*|-|
|TDD 시스템에서 무선 채널 기반 물리 계층 인증에 관한 연구|한국통신학회|서민재, 이채혁, 방인규*, 김태훈*|우수상|
|TDD 시스템에서 무선 채널 기반 비밀키 공유에 관한 연구|한국통신학회|서민재, 권정은, 방인규*, 김태훈*|우수상|
|와이파이 기반 드론 네트워크에서 Evil Twin 공격 구현에 관한 연구|한국통신학회|김태현, 이규호, 서민재, 방인규*, 김태훈*|우수상|
